...
@section('page_title')
{{trans('labels.coupons')}} | {{trans('labels.update')}}
@endsection
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<h4 class="card-title" id="bordered-layout-colored-controls">{{trans('labels.update')}} {{trans('labels.coupons')}}</h4>
			</div>
			<div class="card-body">
				<div class="px-3">
					<form class="form form-horizontal form-bordered" action="{{URL::to('admin/coupons/update-'.$rdata->token)}}" method="POST" enctype="multipart/form-data">
						@csrf
						<div class="form-body">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group row">
										...
										<div class="col-md-10">
											<input type="text" class="form-control" placeholder="{{trans('labels.enter_name')}}" name="name" id="name" value="{{$rdata->name}}">
									...
									<div class="form-group row">
										...
										<div class="col-md-10">
											<input type="text" class="form-control" placeholder="{{trans('labels.input_couponcode')}}" name="code" id="code" value="{{$rdata->code}}" disabled>
									...
									<div class="form-group row">
										...
										<div class="col-md-10">
											<input type="number" class="form-control" placeholder="{{trans('labels.enter_price')}}" name="price" id="price" min="1" value="{{$rdata->price}}">
									...
									<div class="form-group row">
										...
										<div class="col-md-10">
											<input type="date" class="form-control" placeholder="{{trans('labels.enter_active_from')}}" name="active_from" id="active_from" value="{{$rdata->active_from}}">
									...
									<div class="form-group row">
										...
										<div class="col-md-10">
											<input type="date" class="form-control" placeholder="{{trans('labels.enter_active_to')}}" name="active_to" id="active_to" value="{{$rdata->active_to}}">
									...
									<div class="form-group row">
										...
										<div class="col-md-10">
											<input type="number" class="form-control" placeholder="{{trans('labels.enter_limit')}}" name="limit" id="limit" min="0" value="{{$rdata->limit}}">
